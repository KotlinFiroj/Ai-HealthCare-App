...
from app.api.v1.endpoints import auth, patients, doctors, appointments, reports, chat, analytics, admin, ai, hospitals, payments, ws
...
app.add_api_websocket_route(f"{settings.API_V1_STR}/ws/connect", ws.websocket_endpoint)
